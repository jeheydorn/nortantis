...
public final class Edge
{
	...
	/**
	 * Set _clippedVertices to contain the two ends of the portion of the Voronoi edge that is visible within the bounds. If no part of the
	 * Edge falls within the bounds, leave _clippedVertices null.
	 *
	 * @param bounds
	 *
	 */
