...
public final class Site implements ICoord
{
	...
	/**
	 * sort sites on y, then x, coord also change each site's _siteIndex to match its new position in the list so the _siteIndex can be used
	 * to identify the site for nearest-neighbor queries
	 *
