...
{
	public static final String currentVersion = "2.83";
	...
	public Stroke regionBorderStyle = new Stroke(StrokeType.Dotted, (float) MapCreator.calcSizeMultipilerFromResolutionScale(1.0));
	/**
